        ...
        @if (!loading() && area()) {
          ...
          <section class="bg-superficie py-9 border-b border-borda">
            <div class="max-w-5xl mx-auto px-6 text-center">
              <h2 class="text-xl font-bold text-texto mb-1">O que você quer aprender agora?</h2>
              <p class="text-texto-suave text-sm mb-6">Clique em um assunto da área e conheça</p>
          ...
          <section class="max-w-5xl mx-auto px-6 py-10">
            ...
            @if (!cursosLoading() && tipoGrupos().length === 0) {
              <div class="text-center py-16">
                ...
                <p class="text-texto-suave mt-4">Nenhum curso nesta categoria.</p>
                <button (click)="selecionarCategoria(null)"
                  class="mt-3 text-marca hover:underline bg-transparent border-0 cursor-pointer text-sm font-medium">
                  Ver todos os tipos
                </button>
              </div>
            }
              ...
              <div class="space-y-2">
                ...
                class="w-full flex items-center justify-between px-6 py-4 hover:bg-superficie-2
                    ...
                    @if (isOpen(grupo.nome)) {
                      <div
                        class="border-t border-borda px-6 py-6">
          ...
          <!-- ══════════════════════════ BANNER PARCEIRO ══════════════════════════ -->
          <section class="bg-marca-profunda py-16">
